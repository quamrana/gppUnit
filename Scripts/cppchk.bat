@echo off
cppcheck --version
cppcheck --enable=all --inconclusive --suppressions-list=suppressions.txt --quiet -j 8 -I . -I .\src -I .\Matchers -I .\TableFormatting -I .\ApprovalsTest --template vs src Matchers TableFormatting ApprovalsTest 2>&1 | find /V "cppcheck: unusedFunction check"
